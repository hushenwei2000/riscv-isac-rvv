...
def isac(output_file,elf ,trace_file, window_size, cgf, parser_name, decoder_name, parser_path, decoder_path, detailed, test_labels,
        sig_labels, dump, cov_labels, xlen, flen, vlen, vsew, no_count, procs, logging=False):
    test_addr = []
    sig_addr = []
    if parser_path:
    ...
    rpt = cov.compute(trace_file, test_name, cgf, parser_name, decoder_name, detailed, xlen, flen, vlen, vsew, test_addr, dump, cov_labels, sig_addr, window_size, no_count, procs)
